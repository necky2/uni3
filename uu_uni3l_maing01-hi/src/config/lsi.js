const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci uuUni3l",
      en: "About application uuUni3l",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuUni3l.",
      en: "You can buy your own uuUni3l.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuUni3l.",
      en: "You don't have rights to initialize this uuUni3l.",
    },
  },
